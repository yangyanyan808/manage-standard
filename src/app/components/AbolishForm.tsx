    ...
    <div className="max-w-6xl mx-auto space-y-6 pb-12">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-slate-500 mt-0.5">
              {isEdit ? "修改废止内容并重新提交" : "选择需要废止的制度或流程，填写废止原因"}
            </p>
          </div>
        </div>
        <div className="flex items-center gap-3">
      ...
      <form className="space-y-6">
        ...
        <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
          ...
          {/* Selected Standard Info + Abolish Reason */}
          <div className="p-6 space-y-6">
            {selectedStandard ? (
              <>
                ...
                <div className="border-t border-slate-100 pt-6">
                  <div className="space-y-2">
                    <label className="text-sm font-medium text-slate-700">废止原因 <span className="text-red-500">*</span></label>
                    <textarea
                      value={abolishReason}
                      onChange={(e) => setAbolishReason(e.target.value)}
                      rows={4}
                      placeholder="请详细描述废止原因，包括废止的必要性、替代方案、影响范围等..."
              ...
              <p className="text-sm text-slate-400 text-center py-8">
                请点击"选择制度/流程"按钮，从现有制度/流程中选择需要废止的对象
              </p>
            )}
          </div>
        </div>
